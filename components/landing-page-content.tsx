                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <div className="flex items-center gap-4">
                                {user ? (
                                    <Link href="/dashboard" className="px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors flex items-center gap-2">
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="px-4 py-4 space-y-4 flex flex-col">
                            ...
                            {user ? (
                                <Link href="/dashboard" className="w-full text-center px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium flex items-center justify-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
                                    <LayoutDashboard size={16} />
                                    Dashboard
                                </Link>
                            ) : (
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            {user ? (
                                <Link href="/dashboard" className="w-full sm:w-auto px-8 py-3 rounded-full bg-primary text-primary-foreground font-semibold flex items-center justify-center gap-2 hover:bg-primary/90 transition-all shadow-lg hover:shadow-primary/25">
                    ...
                    >
                        <div className="aspect-auto md:aspect-[16/9] rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-2xl ring-1 ring-white/10 flex items-center justify-center overflow-hidden">
                            {/* UI Container */}
                            <div className="w-full h-full bg-background/95 p-4 sm:p-8 flex flex-col gap-6 backdrop-blur-xl">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-primary rounded-3xl p-8 sm:p-16 text-center text-primary-foreground relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            {user ? (
                                <Link href="/dashboard" className="px-8 py-3 bg-background text-foreground rounded-full font-semibold hover:bg-secondary transition-colors inline-block">
                                    Go to Dashboard
                                </Link>
                            ) : (
